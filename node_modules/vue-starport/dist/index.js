...
function createStarportInstance(port, component, inlineOptions = {}) {
  ...
  const options = vue.computed(() => __spreadValues$2(__spreadValues$2(__spreadValues$2({}, defaultOptions), inlineOptions), localOptions.value));
...
const Starport = vue.defineComponent({
  ...
  setup(props, ctx) {
    ...
    return () => {
      ...
      return vue.h(StarportProxy, __spreadProps(__spreadValues({}, props), {
        key: props.port,
