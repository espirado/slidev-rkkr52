...
import { reactive, ref, effectScope, computed, watch, nextTick, defineComponent, inject, h, Teleport, mergeProps, onMounted, onBeforeUnmount, getCurrentInstance, isVNode, markRaw } from 'vue';
